...
function Auth() {
    ...
    const handleGoogleSignIn = async ()=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__g__as__signInWithRedirect$3e$__["signInWithRedirect"])(auth, provider);
        } catch (error) {
...
_s(Auth, "Y5sP+hYjchAod7jCxBhfqujkc9k=", false, function() {
    return [
...
function NoteList() {
    ...
    const notesQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "NoteList.useMemoFirebase[notesQuery]": ()=>{
            if (!user) return null;
            const baseQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(firestore, `users/${user.uid}/tasks`);
            let conditions = [];
            if (filterStatus !== 'all') {
                conditions.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])('completed', '==', filterStatus === 'completed'));
            }
            if (filterTag !== 'all') {
                conditions.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])('tags', 'array-contains', filterTag));
            }
...
_s(NoteList, "tJJnupPzI3BrwMJPCGHylmmwVo4=", false, function() {
    return [
...
//# sourceMappingURL=src_components_d9bf8d27._.js.map