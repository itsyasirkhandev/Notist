    ...
    if (!firestoreInstance) {
        try {
            firestoreInstance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeFirestore"])(firebaseApp, {
                cache: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persistentLocalCache"])()
            });
        } catch (e) {
...
function OfflineWarning() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OfflineWarning.useEffect": ()=>{
            if (!isOnline) {
                const timer = setTimeout({
                    "OfflineWarning.useEffect.timer": ()=>setShow(true)
                }["OfflineWarning.useEffect.timer"], 3000); // delay of 3 seconds
                return ({
                    "OfflineWarning.useEffect": ()=>clearTimeout(timer)
                })["OfflineWarning.useEffect"];
            } else {
                setShow(false);
            }
...
_s(OfflineWarning, "FFa8tmI4L1TEVuim1QekmzAfCCo=", false, function() {
    return [
...
//# sourceMappingURL=src_f8de3c46._.js.map